...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxUiGraphicsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>ui.graphics.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
    ...
    public static class CoilVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coil.compose</b> with value <b>2.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class CoreVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>core.ktx</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FoundationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>foundation.android</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class HiltVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hilt.android</b> with value <b>2.47</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinxCollectionsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.collections.immutable</b> with value <b>0.3.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.coroutines.android</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lifecycle.runtime.compose</b> with value <b>2.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LottieVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lottie.compose</b> with value <b>5.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RoomVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>room.common</b> with value <b>2.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>room.ktx</b> with value <b>2.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class UiVersionAccessors extends VersionFactory  {
        ...
        private final UiGraphicsVersionAccessors vaccForUiGraphicsVersionAccessors = new UiGraphicsVersionAccessors(providers, config);
        public UiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.ui.graphics</b>
         */
        public UiGraphicsVersionAccessors getGraphics() {
            return vaccForUiGraphicsVersionAccessors;
        }

    }

    public static class UiGraphicsVersionAccessors extends VersionFactory  {

        public UiGraphicsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>ui.graphics.android</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("ui.graphics.android"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>hiltLibrary</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hilt.android</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHiltLibrary() { return createPlugin("hiltLibrary"); }
